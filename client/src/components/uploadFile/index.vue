<template>
	<div class="h100 priUp">
		<el-upload :on-success="uploadSuccess" :class="{maxFile:state.fileList.length >= limit}" class="h100" action="/api/uploadFile" :limit="limit"   v-model:file-list="state.fileList" list-type="picture-card" 
